    ...
    <>
      <div className="flex items-end justify-between">
        <div>
          ...
          <div className="text-sm text-slate-600 dark:text-slate-400">Business headlines (current week)</div>
        </div>
            ...
            <div className="space-y-3">
              <div className="grid grid-cols-1 gap-3">
                {items.map((n) => {
                  ...
                  const content = (
                    <div className="rounded-xl border border-slate-200 bg-white/70 p-4 hover:bg-white dark:border-slate-800 dark:bg-slate-950/40 dark:hover:bg-slate-900/50">
                      <div className="flex items-start justify-between gap-3">
                        <div className="min-w-0">
                          <div className="truncate text-sm font-semibold text-slate-900 dark:text-slate-100" title={n.title}>
                            {n.title}
                          </div>
                          {summaryText ? (
                            <div className="mt-1 text-sm leading-snug text-slate-700 dark:text-slate-300">{summaryText}</div>
                          ) : null}
