  ...
  return (
    <>
      <div>
        ...
        <div className="text-sm text-slate-600 dark:text-slate-400">Live (Upstox) + Paper portfolio snapshot</div>
      </div>
                  ...
                  return (
                    <>
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        <div className="rounded-xl border border-slate-200 bg-white/70 p-3 dark:border-slate-800 dark:bg-slate-950/40">
                          <div className="text-xs text-slate-600 dark:text-slate-400">1D P&L</div>
                          <div
                            className={clsx(
                              'mt-1 text-lg font-semibold',
                              totals.dayPnlKnown
                      ...
                      <div className="max-h-[560px] overflow-y-auto overflow-x-hidden rounded-xl border border-slate-200 dark:border-slate-800">
                        <table className="w-full table-fixed text-sm">
                          <thead className="sticky top-0 bg-slate-50 text-left text-[11px] text-slate-600 backdrop-blur dark:bg-slate-950/90 dark:text-slate-400">
                            <tr>
                          ...
                          <tbody>
                            {rows.map(({ h, m, key }, idx) => (
                              <tr key={h.instrument_token ?? h.instrument_key ?? key ?? idx} className="border-t border-slate-200 dark:border-slate-800">
                                ...
                                <td className="py-2 pr-3 text-right text-slate-700 dark:text-slate-200">{fmt(m.qty)}</td>
                                <td className="hidden py-2 pr-3 text-right text-slate-700 dark:text-slate-200 sm:table-cell">{fmt(m.avg)}</td>
                                <td className="hidden py-2 pr-3 text-right text-slate-700 dark:text-slate-200 sm:table-cell">
                                  {m.ltp !== null ? fmt(m.ltp) : '—'}
                                </td>
                                <td
                                  className={clsx(
